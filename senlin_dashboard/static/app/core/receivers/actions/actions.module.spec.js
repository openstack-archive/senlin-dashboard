...
(function() {
  ...
  describe('receiver actions module', function() {
    var registry;
    ...
    it('registers Delete as a batch action', function() {
      var actions = registry.getResourceType('OS::Senlin::Receiver').batchActions;
      expect(actionHasId(actions, 'batchDeleteReceiverAction')).toBe(true);
    });
