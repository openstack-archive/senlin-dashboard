...
(function() {
  ...
  /**
   * @ngdoc factory
   * @name horizon.cluster.profiles.actions.create.service.workflow
   * @ngController
   *
   * @description
   * Workflow for creating new cluster profile
   */
  angular
    .module('horizon.cluster.profiles.actions')
    .factory('horizon.cluster.profiles.actions.create.service.workflow', ProfileWorkflow);
